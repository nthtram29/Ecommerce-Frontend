...
const PostsDetailPage = () => {
  ...
  return (
    ...
    <div style={{ width: '1100px', margin: '0 auto', height:'100%'}}>
      <div style={{fontWeight: '500', margin: '0', padding: '20px 0'}}><span style={{cursor: 'pointer'}} onClick={()=> {navigate('/')}}>Trang chủ / </span> <span style={{cursor: 'pointer'}} onClick={()=> {navigate('/posts')}}>Bài viết / </span> Chi tiết bài viết</div>
